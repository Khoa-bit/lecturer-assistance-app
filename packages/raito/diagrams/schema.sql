...
CREATE TABLE `experience` (`created` TEXT DEFAULT '' NOT NULL, `description` TEXT DEFAULT '', `endTime` TEXT DEFAULT '', `id` TEXT PRIMARY KEY NOT NULL, `isCurrent` BOOLEAN DEFAULT FALSE, `location` TEXT DEFAULT '', `organizationName` TEXT DEFAULT '', `person` TEXT DEFAULT '', `startTime` TEXT DEFAULT '', `title` TEXT DEFAULT '', `updated` TEXT DEFAULT '' NOT NULL);
