...
CREATE TABLE `advisors` (`created` TEXT DEFAULT '' NOT NULL, `id` TEXT PRIMARY KEY NOT NULL, `person` TEXT DEFAULT '', `updated` TEXT DEFAULT '' NOT NULL);
...
CREATE TABLE `classes` (`advisor` TEXT DEFAULT '', `classId` TEXT DEFAULT '', `cohort` TEXT DEFAULT '', `created` TEXT DEFAULT '' NOT NULL, `department` TEXT DEFAULT '', `document` TEXT DEFAULT '', `id` TEXT PRIMARY KEY NOT NULL, `trainingSystem` TEXT DEFAULT '', `updated` TEXT DEFAULT '' NOT NULL);
...
CREATE TABLE `courses` (`courseTemplate` TEXT DEFAULT '', `created` TEXT DEFAULT '' NOT NULL, `document` TEXT DEFAULT '', `id` TEXT PRIMARY KEY NOT NULL, `lecturer` TEXT DEFAULT '', `semester` TEXT DEFAULT '', `updated` TEXT DEFAULT '' NOT NULL);
...
CREATE TABLE `fullDocuments` (`created` TEXT DEFAULT '' NOT NULL, `document` TEXT DEFAULT '', `id` TEXT PRIMARY KEY NOT NULL, `updated` TEXT DEFAULT '' NOT NULL, "category" TEXT DEFAULT '');
CREATE INDEX `_gcqfd846lugrlnj_created_idx` ON `fullDocuments` (`created`);
CREATE TABLE `lecturers` (`created` TEXT DEFAULT '' NOT NULL, `id` TEXT PRIMARY KEY NOT NULL, `person` TEXT DEFAULT '', `updated` TEXT DEFAULT '' NOT NULL);
